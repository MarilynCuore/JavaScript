...
function capacityOfZoo(visitor, entrancePrice){
  if(zoo.newVisitor <  2000){
    zoo.newVisitor ++
    if( entrancePrice = kids ){
      console.log('Debe pagar entrancePrice[kids]')
    } else if( entrancePrice = old){
      console.log('Debe pagar ntrancePrice[old]')
    }else if(entrancePrice = students){
      console.log('Debe pagar ntrancePrice[students]')
    }else{
      console.log('Debe pagar ntrancePrice[rest]')
    }
  }
}